...
public class provider {
	...
	public provider(String providerId, String providerName, String providerAddress, String linkman, int fid,
			String providerPhone, String register, String checker) {
		super();
		this.providerId = providerId;
		this.providerName = providerName;
		this.providerAddress = providerAddress;
	...
	public String toString() {
		return "provider [id=" + id + ", providerId=" + providerId + ", providerName=" + providerName
				...
				+ change_time + ", change_tag=" + change_tag + ", delete_tag=" + delete_tag + ", fname=" + fname + "]";
	}
